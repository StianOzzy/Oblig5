...
all_wares = {
    "amd_processor": {
        ...
        "description": "All the cores you'll ever need!",
    },
    "playstation_5": {
        "name": "PlayStation 5",
        "price": 5999.0,
...
ws.add_ware_to_shopping_cart("amd_processor", all_wares["amd_processor"], shopping_cart)
ws.add_ware_to_shopping_cart("playstation_5", all_wares["playstation_5"], shopping_cart, 2)
ws.add_ware_to_shopping_cart("hdmi_cable", all_wares["hdmi_cable"], shopping_cart, 4)
